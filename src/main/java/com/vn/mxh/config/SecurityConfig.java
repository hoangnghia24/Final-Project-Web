    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/css/**", "/js/**", "/images/**", "/client/**", "/auth/**", "/resources/**",
                                "/uploads/**")
                        .permitAll()
                        ...
                        .requestMatchers("/", "/home", "/login", "/register", "/profile/**", "/u/**", "/messages",
                                "/edit-avatar", "/update-avatar", "/chat-test-to-admin", "/trending", "/explore",
                                "/all")
                        .permitAll()
